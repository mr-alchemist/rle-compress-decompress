...
public class Rle {
	...
	void showHelp() {
		System.out.println("");
		String help = "Использование для компрессии:   rle [-c] <имя исходного(сжимаемого) файла> [<имя файла-результата>]\n" +
					   "Использование для декомпрессии: rle -d <имя сжатого файла> <имя файла-результата>\n" +
					  "\n" +
					  "Параметры: \n" +
					  " -c <имя файла 1> [<имя файла 2>]   Компрессия(сжатие) файла.\n" +
					  "                                    <имя файла 1> - имя сжимаемого файла, обязательный параметр.\n" +
					  "                                    <имя файла 2> - имя файла-результата, необязательный параметр.\n" +
					  "                                    В случае отсутствия <имя файла 2>, результат сжатия записывается в файл <имя файла 1>.rle.\n" +
					  "\n" +
					  " -d <имя файла 1> <имя файла 2>     Декомпрессия файла.\n" +
					  "                                    <имя файла 1> - имя сжатого файла, обязательный параметр.\n" +
					  "                                    <имя файла 2> - имя файла-результата, обязательный параметр.\n" +
					  "\n" +
					  " Если нет явного указания параметров -c и -d, то по-умолчанию задействуется опция -c (компрессия).\n" +
					  " Например, команда \"rle 1.txt\" сожмет содержимое файла \"1.txt\" и выведет результат в файл \"1.txt.rle\"";
