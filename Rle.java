...
public class Rle {
	...
	void showHelp() {
		...
		System.out.println(" -c <имя файла 1> [<имя файла 2>]   Компрессия(сжатие) файла.");
		System.out.println("                                    <имя файла 1> - имя сжимаемого файла, обязательный параметр.");
		System.out.println("                                    <имя файла 2> - имя файла-результата, необязательный параметр.");
		System.out.println("                                    В случае отсутствия <имя файла 2>, результат сжатия записывается в файл <имя файла 1>.rle.");
		System.out.println("");
		System.out.println(" -d <имя файла 1> <имя файла 2>     Декомпрессия файла.");
		System.out.println("                                    <имя файла 1> - имя сжатого файла, обязательный параметр.");
		System.out.println("                                    <имя файла 2> - имя файла-результата, обязательный параметр.");
		System.out.println("");
		System.out.println(" Если нет явного указания параметров -c и -d, то по-умолчанию задействуется опция -c (компрессия).");
		System.out.println(" Например, команда \"rle 1.txt\" сожмет содержимое файла \"1.txt\" и выведет результат в файл \"1.txt.rle\"");
	}
